...
//        $path = CORE_TEST_CASES . DS;
        ...
        */
        $suite->addTestFile($path . 'Controller' . DS . 'ControllerTest.php');
        $suite->addTestFile($path . 'Console' . DS . 'ConsoleTest.php');
        $suite->addTestFile($path . 'Model' . DS . 'ModelTest.php');
        $suite->addTestFile($path . 'Lib' . DS . 'LibTest.php');
        $suite->addTestFile($path . 'Config' . DS . 'ConfigTest.php');
